...
(function() {
  ...
  (function injectFooterStyles() {
    ...
    var css = ""
      ...
      + "@media (max-width:900px){.nav__inner{padding:0 16px;gap:8px;}.nav__logo{margin-right:auto;height:40px;}.nav__logo svg{height:17px;}.nav__right{margin-left:0;}.nav__burger{display:flex !important;}.nav__links{display:none !important;}}"
