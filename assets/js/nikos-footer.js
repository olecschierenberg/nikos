...
(function() {
  // Globale Mobile-Korrekturen fuer Footer + Cookie-Modal (auf jeder Seite)
  (function injectFooterStyles() {
    if (document.getElementById('nk-footer-mobile-css')) return;
    var css = ""
      + "body{overflow-x:hidden;}"
      + ".nk-nav,.nav__inner{max-width:100vw;}"
      + "@media (max-width:900px){.nav__inner{padding:0 16px;gap:8px;}.nav__logo{margin-right:auto;height:40px;}.nav__logo svg{height:20px !important;width:auto !important;}.nav__logo img{height:20px !important;width:auto !important;}.nav__right{margin-left:0;}.nav__burger{display:flex !important;}.nav__links{display:none !important;}}"
      ...
      + ".nk-footer__brand-features li,.nk-footer__links a,.nk-footer__col-title{overflow-wrap:anywhere;word-break:break-word;}"
      + ".nk-footer__copy-link{color:inherit;text-decoration:none;transition:color .2s;}"
      + ".nk-footer__copy-link:hover{color:var(--orange,#FF6600);text-decoration:underline;}"
      + "@media (max-width:1024px){.nk-footer__grid{grid-template-columns:1fr 1fr;}}"
      + "@media (max-width:760px){"
      +   ".nk-footer__brand-logo svg{height:20px !important;}"
      +   ".nk-footer__grid{grid-template-columns:1fr;gap:32px;}"
      +   ".nk-footer__bottom{flex-direction:column;align-items:flex-start;gap:16px;}"
      +   ".nk-footer__bottom-links{flex-wrap:wrap;gap:12px 20px;}"
      + "}"
      + "@media (max-width:560px){"
      +   "#cookieModal>div{padding:24px 20px!important;}"
      +   "#cookieModal h2{font-size:18px!important;}"
      +   "#cookieModal>div>div:last-child{flex-direction:column!important;}"
      +   "#cookieModal>div>div:last-child button{flex:1 1 auto!important;width:100%!important;}"
      + "}";
    var st = document.createElement('style');
    st.id = 'nk-footer-mobile-css';
    st.textContent = css;
